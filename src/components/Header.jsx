export default function Header() {
  return (
    <header className="md:flex lg:flex md:bg-dark lg:bg-dark">
      ...
      <div className="sm:bg-gray md:bg-dark lg:bg-dark pt-2 pb-2 md:pr-28 lg:pr-28 m-auto text-center">
        <h1 className="text-xl md:text-4xl text-white text-shadow-glow">LOREM IPSUM</h1>
        <p className="text-darkwhite sm:text-xxs md:text-sm lg:text-xl">LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM</p>
      </div>
    </header>
  );
}
