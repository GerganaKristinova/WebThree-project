  ...
  return (
    <header className="md:flex lg:flex md:bg-dark lg:bg-dark">
      <div className="flex bg-dark h-13.5 md:h-20 pl-6 pt-2 md:pl-7.5 md:pt-3">
        ...
        <h4 className="font-sans leading-5 md:leading-6 lg:leading-6 text-white text-sm md:text-xl lg:text-2xl pl-2 pt-3 md:pl-3 md:pt-4 lg:pl-3 lg:pt-3.5">Logo</h4>
      </div>
